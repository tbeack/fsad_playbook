...
- [x] `CBP-530` Research: build the fact base for a "how to build your own harness" guide (Claude Code + Codex) → [task-cbp-530.md](completed/task-cbp-530.md)
- [x] `CBP-531` Plan a refactor of the Harness Engineering page: new structure, organization, flow, markdown snippets, and a mermaid-diagram mockup → [task-cbp-531.md](completed/task-cbp-531.md)
...
- [x] `CBP-537` [Codex] Add `/worktree` row to the Cheat Sheet slash-commands table (rust-v0.154.0) → [task-cbp-537.md](completed/task-cbp-537.md)
- [x] `CBP-538` [Codex] Add a "Worktree Sessions" Power Usage collapsible (rust-v0.154.0) → [task-cbp-538.md](completed/task-cbp-538.md)
- [x] `CBP-539` [Codex] Add an "Inline Async Questions" Power Usage collapsible (rust-v0.154.0) → [task-cbp-539.md](completed/task-cbp-539.md)
- [x] `CBP-540` [Codex] Update the Vim Editing Mode collapsible to cover `R` replace mode (rust-v0.154.0) → [task-cbp-540.md](completed/task-cbp-540.md)
...
- [x] `CBP-550` [Claude] Add `/output-style` row to Claude Cheat Sheet — Configuration & setup table (v2.1.269) → [task-cbp-550.md](task-cbp-550.md)
- [x] `CBP-551` [Claude] Document `claude plugin eval` in Power Usage → Plugins collapsible (v2.1.269) → [task-cbp-551.md](task-cbp-551.md)
- [x] `CBP-552` [Claude] Document `CLAUDE_CODE_WORKFLOW_MAX_CONCURRENT_AGENTS` in Power Usage → Dynamic Workflows collapsible (v2.1.269) → [task-cbp-552.md](task-cbp-552.md)
...
- [x] `CBP-558` [Claude] Add per-command `allowed_domains` for Bash/PowerShell/Monitor in auto mode — Subprocess Sandboxing collapsible (v2.1.271) → [task-cbp-558.md](task-cbp-558.md)
- [x] `CBP-559` [Claude] Add `omitClaudeMd` agent frontmatter note — Frontmatter Reference collapsible (v2.1.271) → [task-cbp-559.md](task-cbp-559.md)
- [x] `CBP-560` [Claude] Add `--accept-command <sha256>` flag note to Plugins collapsible (v2.1.271) → [task-cbp-560.md](task-cbp-560.md)
...
- [x] `CBP-576` [Codex] Update `/worktree` row + Worktree Sessions collapsible — ownership details, confirmed deletion (rust-v0.155.0) → [task-cbp-576.md](task-cbp-576.md)
- [x] `CBP-577` [Codex] Update agents dashboard note — task hide, archive, delete (rust-v0.155.0) → [task-cbp-577.md](task-cbp-577.md)
- [x] `CBP-578` [Codex] Add Touch ID verification for MCP requests to Project Trust callout (rust-v0.155.0) → [task-cbp-578.md](task-cbp-578.md)
...
- [x] `CBP-596` [Claude] Add `attribution: false` top-level settings.json key to Notable Settings (v2.1.281) → [task-cbp-596.md](task-cbp-596.md)
- [x] `CBP-597` [Claude] Add auto mode classifier read-only/sandboxed shell command review note to Notable Settings (v2.1.281) → [task-cbp-597.md](task-cbp-597.md)
- [x] `CBP-598` [Claude] Extend Subprocess Sandboxing paragraph — dangerous-rm timeout + substitution-output rm prompt (v2.1.281) → [task-cbp-598.md](task-cbp-598.md)
