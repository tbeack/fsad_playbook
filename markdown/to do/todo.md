...
- [x] `CBP-287` [Claude] Add `CLAUDE_ENABLE_STREAM_WATCHDOG=0` to hardening env vars table (v2.1.196) → [task-cbp-287.md](task-cbp-287.md)
- [x] `CBP-288` [Claude] Add Claude Sonnet 5 as new default model to Model & Effort section (v2.1.197) → [task-cbp-288.md](task-cbp-288.md)
- [x] `CBP-289` [Claude] Update `/agents` Cheat Sheet row — wizard removed; ask Claude or edit `.claude/agents/` directly (v2.1.198) → [task-cbp-289.md](task-cbp-289.md)
- [x] `CBP-290` [Claude] Update `Notification` hook event row to note `agent_needs_input` / `agent_completed` event types (v2.1.198) → [task-cbp-290.md](task-cbp-290.md)
...
- [x] `CBP-296` [Claude] Rename "Default" permission mode to "Manual" across Permission Modes card, Shift+Tab row, `--permission-mode` flag, and cycle caption (v2.1.200) → [task-cbp-296.md](task-cbp-296.md)
- [x] `CBP-297` [Claude] Update `/diff` Cheat Sheet row with fullscreen panel behavior (v2.1.260) → [task-cbp-297.md](task-cbp-297.md)
- [x] `CBP-298` [Claude] Add `/output-style [name]` to Cheat Sheet (v2.1.269) → [task-cbp-298.md](task-cbp-298.md)
- [x] `CBP-299` [Claude] Add `/skill-doctor` to Cheat Sheet (v2.1.261) → [task-cbp-299.md](task-cbp-299.md)
- [x] `CBP-300` [Claude] Add `/advisor [model|off]` to Cheat Sheet (v2.1.260) → [task-cbp-300.md](task-cbp-300.md)
- [x] `CBP-301` [Claude] Add `PreModelSwitch`/`PostModelSwitch` hook events to Hooks table (v2.1.252) → [task-cbp-301.md](task-cbp-301.md)
- [x] `CBP-302` [Claude] Add `omitClaudeMd` tip to agent definition example in Code Review section (v2.1.271) → [task-cbp-302.md](task-cbp-302.md)
- [x] `CBP-303` [Claude] Document per-command `allowed_domains` in Subprocess Sandboxing section (v2.1.271) → [task-cbp-303.md](task-cbp-303.md)
