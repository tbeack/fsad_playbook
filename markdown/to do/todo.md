...
- [x] `CBP-264` [Claude] Add `claude mcp login/logout <name>` CLI commands to `/mcp` Cheat Sheet row (v2.1.186) → [task-cbp-264.md](task-cbp-264.md)
- [x] `CBP-265` [Claude] Add `respondToBashCommands` setting to Notable settings.json Keys callout (v2.1.186) → [task-cbp-265.md](task-cbp-265.md)
- [x] `CBP-266` [Claude] Add `sandbox.credentials` setting to sandbox settings table (v2.1.187) → [task-cbp-266.md](task-cbp-266.md)
- [x] `CBP-267` [Claude] Update `/rewind` Cheat Sheet row: Rewind menu now supports resuming from before `/clear` (v2.1.191) → [task-cbp-267.md](task-cbp-267.md)
- [x] `CBP-268` [Claude] Add `CLAUDE_CODE_RETRY_WATCHDOG` to hardening env vars table (v2.1.186) → [task-cbp-268.md](task-cbp-268.md)
- [x] `CBP-269` [Claude] Add `autoMode.classifyAllShell` to Notable settings.json Keys callout (v2.1.193) → [task-cbp-269.md](task-cbp-269.md)
- [x] `CBP-270` [Claude] Add `claude_code.assistant_response` OTEL event and `OTEL_LOG_ASSISTANT_RESPONSES` to Events & Logs table and Opt-in callout (v2.1.193) → [task-cbp-270.md](task-cbp-270.md)
- [x] `CBP-271` [Claude] Add `CLAUDE_CODE_DISABLE_BG_SHELL_PRESSURE_REAP=1` to hardening env vars table (v2.1.193) → [task-cbp-271.md](task-cbp-271.md)
- [x] `CBP-272` [Claude] Add plugin marketplace auto-rename bullet to Plugins collapsible (v2.1.193) → [task-cbp-272.md](task-cbp-272.md)
- [x] `CBP-273` [Claude] Update `otelHeadersHelper` / Enterprise Configuration to note auto-reconnect on 401/403 (v2.1.193) → [task-cbp-273.md](task-cbp-273.md)
