...
- [x] `CBP-530` Research: build the fact base for a "how to build your own harness" guide (Claude Code + Codex) → [task-cbp-530.md](task-cbp-530.md)
- [x] `CBP-531` Plan a refactor of the Harness Engineering page: new structure, organization, flow, markdown snippets, and a mermaid-diagram mockup → [task-cbp-531.md](task-cbp-531.md)
