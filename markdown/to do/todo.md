...
- [ ] `CBP-459` Implement `playbook-updater`'s Strategy 2 refactor (serialize fan-out; move the verification gate + release steps to the root skill session) → [task-cbp-459.md](task-cbp-459.md)
