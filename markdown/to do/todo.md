...
- [x] `CBP-524` [Claude] Add `/skill-doctor` Cheat Sheet row (v2.1.261) → [task-cbp-524.md](completed/task-cbp-524.md)
- [x] `CBP-525` [Claude] Add `bashOutputMaxChars`/`taskOutputMaxChars` to Notable settings.json Keys (v2.1.261) → [task-cbp-525.md](completed/task-cbp-525.md)
- [x] `CBP-526` [Claude] Add `--append-subagent-system-prompt-file` CLI flag row (v2.1.261) → [task-cbp-526.md](completed/task-cbp-526.md)
- [x] `CBP-527` [Claude] Update `/status` row with Organization policy diagnostic line (v2.1.261) → [task-cbp-527.md](completed/task-cbp-527.md)
- [x] `CBP-528` [Claude] Update `keybindingFlavor` bullets — setting is now a no-op, Bash-style word editing always on (v2.1.261) → [task-cbp-528.md](completed/task-cbp-528.md)
- [x] `CBP-529` [Claude] Add public diagram-renderer auto-mode rule to Notable settings.json Keys (v2.1.261) → [task-cbp-529.md](completed/task-cbp-529.md)
- [x] `CBP-530` [Claude] Extend Subprocess Sandboxing paragraph — dangerous-`rm` prompt catches positional params and quoted `sh -c` scripts (v2.1.261) → [task-cbp-530.md](completed/task-cbp-530.md)
