# CBP-529 — Extend Dangerous-`rm` Safety Prompt Coverage
...
Filed as a follow-up: a concurrent auto-update run (CBP-524 through CBP-528, PR #217) covered the rest of the v2.1.261 changelog but missed this item.
