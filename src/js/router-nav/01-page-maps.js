  ...
  const sectionToPageMap = {
    ...
    'hub': 'practices', 'foundations': 'practices', 'skills-hooks': 'practices', 'operations': 'practices', 'reference': 'practices',
    'codex-hero': 'codex', 'codex-best-practices': 'codex', 'codex-project-anatomy': 'codex', 'codex-integrations': 'codex', 'codex-code-review': 'codex', 'codex-building-skills': 'codex', 'codex-guidelines': 'codex', 'codex-hooks': 'codex', 'codex-cheat-sheet': 'codex', 'codex-power-usage': 'codex',
    'kpis-hero': 'kpis', 'fsad-metrics': 'kpis', 'process-health': 'kpis', 'token-optimization': 'kpis'
  };
